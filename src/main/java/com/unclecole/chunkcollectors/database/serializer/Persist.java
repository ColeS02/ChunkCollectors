...
public class Persist {
    ...
    public File getFile(String name) {
        return new File(ChunkCollectors.getInstance().getDataFolder(), name + ".json");
    }
    ...
    public <T> T loadOrSaveDefault(T def, Class<T> clazz, File file) {
        if (!file.exists()) {
            ChunkCollectors.getInstance().getLogger().info("Creating default: " + file);
            this.save(def, file);
            return def;
        }
        ...
        if (loaded == null) {
            ChunkCollectors.getInstance().getLogger().warning("Using default as I failed to load: " + file);
            ...
            ChunkCollectors.getInstance().getLogger().warning("Backing up copy of bad file to: " + backup);
    ...
    public <T> T load(Class<T> clazz, File file) {
        ...
        try {
            ...
            ChunkCollectors.getInstance().getLogger().warning(ex.getMessage());
        }
